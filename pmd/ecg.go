...
func (h ECGHandler) Handle() (Command, RecordingType, MeasureType, []Setting, func([]byte)) {
	if h == nil {
		return MeasureStop, Online, ECGType, nil, nil
	}
	return MeasureStart, Online, ECGType, []Setting{
