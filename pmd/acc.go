...
func (h AccHandler) Handle() (Command, RecordingType, MeasureType, []Setting, func([]byte)) {
	if h.Handler == nil {
		return MeasureStop, Online, AccType, nil, nil
	}
	return MeasureStart, Online, AccType, []Setting{
